...
return [
    ...
    '/projeto/marcas' => ['Marcas', 'index'],
    '/projeto/marcas/new' => ['Marcas', 'new'],
    '/projeto/marcas/index' => ['Marcas', 'index'],
    '/projeto/marcas/edit/{id}' => ['Marcas', 'edit'],
    '/projeto/marcas/delete/{id}' => ['Marcas', 'delete'],
    '/projeto/marcas/save' => ['Marcas', 'save'],
    '/projeto/marcas/edit_save' => ['Marcas', 'edit_save'],
    '/projeto/marcas/search' => ['Marcas', 'search'],
